...
includeFile("tangible/deed/player_house_deed/barn_no_planet_restriction_deed.lua")
includeFile("tangible/deed/player_house_deed/diner_no_planet_restriction_deed.lua")
