...
object_building_player_ns_hut = object_building_player_shared_ns_hut:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/rem_custom/decorative/mun_kash_signpost_primitive_pointer_small_s01.iff", x = -1.52834, z = 1.39, y = 5.75817, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:mun_kash_signpost_primitive_pointer_small_s01"},
		{templateFile = "object/tangible/rem_custom/decorative/mun_kash_signpost_refined_pointer_small_s01.iff", x = -1.52946, z = 1.39, y = 5.71819, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:mun_kash_signpost_refined_pointer_small_s01"},
