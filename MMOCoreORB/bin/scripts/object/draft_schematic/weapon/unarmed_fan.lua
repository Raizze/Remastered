object_draft_schematic_weapon_unarmed_fan = object_draft_schematic_weapon_shared_unarmed_fan:new {
   ...
   resourceTypes = {"steel_ditanium", "iron", "metal", "copper_polysteel", "object/tangible/loot/dungeon/rem_custom/shared_fan_blade.iff",  "object/tangible/component/weapon/shared_vibro_unit.iff"},
