object_draft_schematic_weapon_1h_sword_champions = object_draft_schematic_weapon_shared_1h_sword_champions:new {
   ...
   resourceTypes = {"steel_duralloy", "metal", "aluminum_linksteel", "object/tangible/loot/dungeon/rem_custom/shared_champions_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
