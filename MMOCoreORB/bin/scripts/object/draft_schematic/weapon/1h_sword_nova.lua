object_draft_schematic_weapon_1h_sword_nova = object_draft_schematic_weapon_shared_1h_sword_nova:new {
   ...
   resourceTypes = {"iron_kammris", "metal", "aluminum_linksteel", "object/tangible/loot/dungeon/rem_custom/shared_nova_blade.iff", "object/tangible/component/weapon/shared_reinforcement_core.iff"},
