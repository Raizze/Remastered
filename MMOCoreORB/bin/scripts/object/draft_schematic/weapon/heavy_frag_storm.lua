object_draft_schematic_weapon_heavy_frag_storm = object_draft_schematic_weapon_shared_heavy_frag_storm:new {
   ...
   resourceTypes = {"steel_duralloy", "copper_polysteel", "petrochem_inert_polymer", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/loot/dungeon/rem_custom/shared_barrel_heavy_frag_storm.iff", "steel", "object/tangible/component/weapon/shared_stock.iff"},
