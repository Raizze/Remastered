...
object_draft_schematic_weapon_razor_knuckler = object_draft_schematic_weapon_shared_razor_knuckler:new {
   ...
   resourceTypes = {"steel_quadranium", "aluminum", "metal", "copper_platinite", "object/tangible/loot/dungeon/rem_custom/shared_razor_blade.iff", "object/tangible/component/weapon/shared_vibro_unit.iff"},
