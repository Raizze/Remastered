object_draft_schematic_armor_backpack_marine = object_draft_schematic_armor_shared_backpack_marine:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_armor_backpack_marine, "object/draft_schematic/armor/backpack_marine.iff")
