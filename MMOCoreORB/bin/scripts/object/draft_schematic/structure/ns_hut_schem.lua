object_draft_schematic_structure_ns_hut_schem = object_draft_schematic_structure_shared_ns_hut_schem:new {
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/ns_hut_deed.iff",

   additionalTemplates = {
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_ns_hut_schem, "object/draft_schematic/structure/ns_hut_schem.iff")
