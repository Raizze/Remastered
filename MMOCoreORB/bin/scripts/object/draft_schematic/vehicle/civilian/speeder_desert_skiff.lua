object_draft_schematic_vehicle_civilian_speeder_desert_skiff = object_draft_schematic_vehicle_civilian_shared_speeder_desert_skiff:new {
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_speeder_desert_skiff, "object/draft_schematic/vehicle/civilian/speeder_desert_skiff.iff")
