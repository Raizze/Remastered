object_draft_schematic_vehicle_civilian_organa_speeder = object_draft_schematic_vehicle_civilian_shared_organa_speeder:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "XJ-2 Airpeeder",
...
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_organa_speeder, "object/draft_schematic/vehicle/civilian/organa_speeder.iff")
