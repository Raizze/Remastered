...
function LokImperialOutpostScreenPlay:spawnSceneObjects()
	...
	--Terminals
	spawnSceneObject("lok", "object/tangible/terminal/imp_travel_term.iff", -1931, 12, -3135, 0, 0, 0, 1, 0)
	spawnSceneObject("lok", "object/tangible/beta/beta_terminal_wound.iff", -1945, 12, -3136, 0, 1, 0, 0, 0)
...
function LokImperialOutpostScreenPlay:spawnMobiles()
	...
	spawnMobile("lok", "gcw_at_st", 720, -1762.0, 11.9, -3087.3, 90, 0)
	spawnMobile("lok", "gcw_at_st", 720, -1939.5, 11.8, -2945.9, 0, 0)
	spawnMobile("lok", "gcw_at_st", 720, -2028.9, 11.9, -3107.5, -90, 0)
	spawnMobile("lok", "gcw_at_st", 720, -1918.5, 12.1, -3244.1, 180, 0)
	...
	spawnMobile("lok", "gcw_at_st", 720, -1926.2, 11.8, -3142.9, 90, 0)
	...
	spawnMobile("lok", "stormtrooper_sentry", 300, -2034.3, 12.0, -3058.8, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2038.8, 12.0, -3060.9, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2038.8, 12.0, -3067.1, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2020.8, 12.0, -3067.1, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2021.1, 12.0, -3060.9, -90, 0)
	spawnMobile("lok", "gcw_at_st", 300, -2041.0, 12.0, -3051.9, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1944.5, 12.0, -2970.2, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1934.5, 12.0, -2970.2, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1934.5, 12.0, -2974.0, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1944.5, 12.0, -2974.1, 90, 0)
	spawnMobile("lok", "gcw_at_st", 300, -1958.0, 12.0, -2959.3, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1815.2, 12.0, -3083.9, 90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1815.0, 12.0, -3090.1, 90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1804.6, 12.0, -3090.1, 90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1804.2, 12.0, -3083.8, 90, 0)
	spawnMobile("lok", "gcw_at_st", 300, -1792.5, 12.0, -3065.5, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1910.6, 12.0, -3189.8, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1919.5, 12.0, -3189.6, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1919.5, 12.0, -3193.2, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1910.5, 12.0, -3193.5, 180, 0)
	spawnMobile("lok", "gcw_at_st", 300, -1935.3, 12.0, -3210.8, 180, 0)

	-- Building/Structure Entry Guards

	spawnMobile("lok", "stormtrooper_sentry", 300, -1979.4, 12.0, -3015.5, 136, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1990.6, 12.0, -3026.7, 134, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2011.5, 12.0, -3053.2, 178, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2007.2, 12.0, -3053.0, 178, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2018.5, 12.0, -3080.8, 89, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -2018.5, 12.0, -3085.2, 89, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1950.5, 12.0, -3160.7, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1932.9, 12.0, -3160.7, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1828.7, 12.0, -3099.0, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1824.5, 12.0, -3088.1, 0, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1817.5, 12.0, -3070.2, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1817.5, 12.0, -3065.7, -90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1841.9, 12.0, -3036.0, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1846.1, 12.0, -3036.0, 180, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1922.5, 12.0, -3013.8, -179, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1930.2, 12.0, -3013.7, -179, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1993.5, 12.0, -3111.1, 90, 0)
	spawnMobile("lok", "stormtrooper_sentry", 300, -1993.5, 12.0, -3118.9, 90, 0)
