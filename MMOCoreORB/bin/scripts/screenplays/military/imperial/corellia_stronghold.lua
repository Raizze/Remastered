...
function StrongholdScreenPlay:spawnSceneObjects()
	...
	spawnSceneObject("corellia", "object/tangible/beta/beta_terminal_wound.iff", 4624, 25, -5759, 0, 0, 0, 1, 0)
	spawnSceneObject("corellia", "object/tangible/terminal/terminal_mission_imperial.iff", 4619, 25, -5759, 0, 0, 0, 1, 0)
	spawnSceneObject("corellia", "object/tangible/terminal/imp_travel_term.iff", 4624.67, 25, -5777.21, 0, 0, 0, 1, 0)
...
function StrongholdScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4682.8, 25.0, -5829.8, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4679.7, 25.0, -5832.9, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4690.8, 25.0, -5821.8, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4693.8, 25.0, -5818.8, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4701.7, 25.0, -5810.9, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4704.8, 25.0, -5807.8, -45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4704.8, 25.0, -5760.2, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4701.8, 25.0, -5757.2, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4693.8, 25.0, -5749.2, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4690.7, 25.0, -5746.1, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4682.9, 25.0, -5738.3, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4679.8, 25.0, -5735.2, -135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4623.2, 25.0, -5760.2, 135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4620.2, 25.0, -5763.2, 135, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4619.1, 25.0, -5804.7, 45, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4622.2, 25.0, -5807.8, 45, 0)

	-- Gate/Base Entry Point Sentries

	spawnMobile("corellia", "stormtrooper_sentry", 400, 4680.9, 25.0, -5717.1, -3, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4647.4, 25.0, -5716.5, -5, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4661.9, 25.0, -5716.1, 0, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4663.2, 25.0, -5852.8, 180, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4646.1, 25.0, -5852.3, 180, 0)
	spawnMobile("corellia", "stormtrooper_sentry", 400, 4680.9, 25.0, -5850.7, 180, 0)
	spawnMobile("corellia", "gcw_at_st", 400, 4661.8, 25.0, -5850.3, 180, 0)
	spawnMobile("corellia", "gcw_at_st", 400, 4663.0, 25.0, -5720.2, 0, 0)
	spawnMobile("corellia", "gcw_at_st", 400, 4644.5, 25.0, -5784.1, 90, 0)
