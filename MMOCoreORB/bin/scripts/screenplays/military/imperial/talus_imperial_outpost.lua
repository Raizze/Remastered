...
function TalusImperialOutpostScreenPlay:spawnSceneObjects()
	...
	--Terminals
	spawnSceneObject("talus", "object/tangible/beta/beta_terminal_wound.iff", -2190, 20, 2274, 0, 0, 0, 0, 0)
	spawnSceneObject("talus", "object/tangible/terminal/imp_travel_term.iff", -2223, 20, 2313, 0, 0, 0, 1, 0)

end

function TalusImperialOutpostScreenPlay:spawnMobiles()

	spawnMobile("talus", "gcw_at_st", 300, -2167.8, 20.0, 2411.1, -8, 0)
	...
	spawnMobile("talus", "gcw_at_st", 300, -2198.2, 20.0, 2299.8, 0, 0)
	...
	spawnMobile("talus", "stormtrooper_sentry", 300, -2185.7, 20.0, 2272.4, -1, 0)

	-- Gate Entrance Guards

	spawnMobile("talus", "stormtrooper_sentry", 300, -2175.1, 20.0, 2400.4, 0, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2191.6, 20.0, 2400.8, 0, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2276.6, 20.0, 2258.4, -121, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2267.0, 20.0, 2243.8, -121, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2099.2, 20.0, 2244.3, 121, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2089.0, 20.0, 2258.4, 123, 0)
	spawnMobile("talus", "gcw_at_st", 300, -2200.1, 20.0, 2408.8, 0, 0)
	spawnMobile("talus", "gcw_at_st", 300, -2286.0, 20.0, 2264.2, -134, 0)
	spawnMobile("talus", "gcw_at_st", 300, -2271.9, 20.0, 2230.3, -108, 0)
	spawnMobile("talus", "gcw_at_st", 300, -2092.5, 20.0, 2230.5, 107, 0)
	spawnMobile("talus", "gcw_at_st", 300, -2073.6, 20.0, 2260.2, 131, 0)

	-- Tower Door Entrance Guards

	spawnMobile("talus", "stormtrooper_sentry", 300, -2129.0, 20.0, 2220.7, 17, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2133.3, 20.0, 2221.8, 18, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2085.7, 20.0, 2304.9, -45, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2882.8, 20.0, 2307.8, -45, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2135.7, 20.0, 2325.8, -120, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2137.9, 20.0, 2329.2, -122, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2138.9, 20.0, 2385.3, -107, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2140.1, 20.0, 2389.7, -108, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2232.5, 20.0, 2382.3, -163, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2236.8, 20.0, 2383.6, -160, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2227.3, 20.0, 2329.9, 117, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2229.2, 20.0, 2326.6, 121, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2278.8, 20.0, 2299.1, 135, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2281.9, 20.0, 2296.0, 135, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2226.8, 20.0, 2218.4, 72, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2225.5, 20.0, 2214.0, 72, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2185.2, 20.0, 2251.6, -4, 0)
	spawnMobile("talus", "stormtrooper_sentry", 300, -2181.2, 20.0, 2251.8, -2, 0)
