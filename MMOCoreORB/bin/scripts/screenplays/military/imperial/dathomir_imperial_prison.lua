...
function ImperialPrisonScreenPlay:spawnSceneObjects()
	...
	--Terminals
	spawnSceneObject("dathomir", "object/tangible/terminal/imp_travel_term.iff", -6226, 120, 944, 0, 0, 0, 1, 0)
...
function ImperialPrisonScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "gcw_at_st", 720, -6108.5, 127.0, 1050.2, -33, 0)
	spawnMobile("dathomir", "gcw_at_st", 720, -6080.7, 129.3, 914.7, 162, 0)
	spawnMobile("dathomir", "gcw_at_st", 720, -6255.7, 130.6, 789.3, 162, 0)
