...
function Yavin4ImperialBaseScreenPlay:spawnSceneObjects()
	...
	-- Terminals
	spawnSceneObject("yavin4", "object/tangible/terminal/terminal_mission_imperial.iff", 4053.71, 37.0, -6241.1, 0, 0, 0, 1, 0)
	spawnSceneObject("yavin4", "object/tangible/terminal/terminal_mission.iff", 4053.99, 37.0, -6238.7, 0, 0, 0, 0, 0)
	spawnSceneObject("yavin4", "object/tangible/terminal/imp_travel_term.iff", 4039, 37.0, -6248, 0, 0, 0, 1, 0)
...
function Yavin4ImperialBaseScreenPlay:spawnMobiles()
	...
	-- Gate Sentries
	spawnMobile("yavin4", "gcw_at_st", 720, 4028.7, 37.0, -6349.5, 175, 0)

	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4009.5, 37.0, -6188.0, 0, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4018.4, 37.0, -6185.0, -90, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4046.7, 37.0, -6185.3, 90, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4053.4, 37.0, -6188.0, 0, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4041.6, 37.0, -6273.2, -89, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4021.0, 37.0, -6273.5, 90, 0)

	-- Lambda Shuttle Sentries
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4041.3, 37.0, -6256.7, 0, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4041.2, 37.0, -6253.0, 179, 0)
	
	-- Shuttle Building Sentries
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4047.3, 37.0, -6219.0, 90, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4047.3, 37.0, -6215.2, 90, 0)

	-- Building Entrance Sentries
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4001.7, 37.0, -6209.2, -179, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 3995.1, 37.0, -6209.0, -170, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4061.2, 37.0, -6209.1, -179, 0)
	spawnMobile("yavin4", "stormtrooper_sentry", 300, 4068.0, 37.0, -6209.1, -179, 0)
