...
--Terminals
	spawnSceneObject("dantooine", "object/tangible/terminal/imp_travel_term.iff", -4216.75, 3.0, -2356.32, -1, 0, 0, 1, 0)

end

function DantooineImperialOutpostScreenPlay:spawnMobiles()
	spawnMobile("dantooine", "gcw_at_st", 900, -4230, 3, -2330, 80, 0)
	spawnMobile("dantooine", "gcw_at_st", 900, -4230, 3, -2475, 0, 0)
	...
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4276.7, 3.0, -2410.6, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4276.7, 3.0, -2405.6, 180, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4286.3, 3.0, -2411.7, 180, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4291.3, 3.0, -2416.1, 180, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4291.3, 3.0, -2400.4, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4286.3, 3.0, -2404.4, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4158.3, 3.0, -2399.9, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4163.3, 3.0, -2403.7, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4158.3, 3.0, -2416.0, 180, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4163.3, 3.0, -2412.0, 180, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4172.7, 3.0, -2410.0, 0, 0)
	spawnMobile("dantooine", "stormtrooper_sentry", 300, -4172.8, 3.0, -2405.7, 180, 0)
