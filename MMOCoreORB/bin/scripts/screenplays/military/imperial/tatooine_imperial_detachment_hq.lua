...
function ImperialDetachmentHQScreenPlay:spawnSceneObjects()
	...
	-- Terminals
	spawnSceneObject("tatooine", "object/tangible/beta/beta_terminal_wound.iff", -2569.07, 5.5, 2901.67, 0, 0, 0, 1, 0)
	spawnSceneObject("tatooine", "object/tangible/terminal/terminal_mission_imperial.iff", -2573.83, 5.5, 2092.58, 0, 0, 0, 1, 0)
	spawnSceneObject("tatooine", "object/tangible/terminal/imp_travel_term.iff", -2586, 5.5, 2077, 0, 0, 0, 1, 0)
...
function ImperialDetachmentHQScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "gcw_at_st", 300, -2583.5, 5.2, 2102.6, -86, 0)
	spawnMobile("tatooine", "gcw_at_st", 300, -2580.2, 5.3, 2112.2, -84, 0)
	...
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2571.0, 5.5, 2090.9, -116, 0)
	...
	-- Office Exterior
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2573.94, 5.5, 2131.27, 180, 0)
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2578.4, 5.4, 2132.1, -170, 0)
	
	-- Barracks Exterior
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2568.7, 5.69, 2118.6, -90, 0)
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2568.0, 5.7, 2122.4, -80, 0)
	
	-- Bunker Exterior
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2576.48, 5.36, 2098.1, -90, 0)
	spawnMobile("tatooine", "stormtrooper_sentry", 300, -2575.7, 5.4, 2101.9, -81, 0)
...
--	spawnMobile("tatooine", "imperial_colonel", 300, 13.72, -11.5, -21.06, -41, 1250076)
