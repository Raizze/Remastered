...
function RoriImperialEncampmentScreenPlay:spawnSceneObjects()
	...
	-- Terminals
	spawnSceneObject("rori", "object/tangible/beta/beta_terminal_wound.iff", -5580.0, 76.0, -5619.7, 0, 0, 0, 1, 0)
	spawnSceneObject("rori", "object/tangible/terminal/terminal_mission_imperial.iff", -5573.2, 76.0, -5617.9, 0, 0, 0, 1, 0)
	spawnSceneObject("rori", "object/tangible/terminal/imp_travel_term.iff", -5568, 76.0, -5615, 0, 0, 0, 1, 0)
...
--inside the walls (not in buildings)
	...
	spawnMobile("rori", "gcw_at_st", 720, -5597.3, 75.9, -5660.5, 0, 0)
	spawnMobile("rori", "gcw_at_st", 720, -5531.5, 75.9, -5660.5, 180, 0)
	...
	spawnMobile("rori", "stormtrooper_sentry", 360, -5500.4, 75.9, -5656.2, 92, 0)
	spawnMobile("rori", "stormtrooper_sentry", 360, -5500.4, 75.7, -5672.1, 95, 0)

	spawnMobile("rori", "stormtrooper_rifleman_sentry", 360, -5630.1, 75.9, -5670.2, -87, 0)
	spawnMobile("rori", "stormtrooper_sniper_sentry", 360, -5630.1, 75.9, -5653.9, -88, 0)
	spawnMobile("rori", "stormtrooper_squad_leader_sentry", 360, -5571.0, 76.0, -5630.7, -2, 0)

	spawnMobile("rori", "stormtrooper_combat_medic_sentry", 360, -5559.7, 76.0, -5631.5, 0, 0)
	spawnMobile("rori", "stormtrooper_bombardier_sentry", 360, -5550.6, 76.0, -5687.5, 95, 0)

	spawnMobile("rori", "stormtrooper_rifleman_sentry", 360, -5520.6, 76.0, -5682.2, 67, 0)
	spawnMobile("rori", "stormtrooper_rifleman_sentry", 360, -5518, 76.0, -5644.1, 86, 0)

	spawnMobile("rori", "stormtrooper_sniper_sentry", 360, -5609.6, 76.0, -5642.9, -120, 0)
	spawnMobile("rori", "stormtrooper_sentry", 360, -5609.6, 76.0, -5681.6, -91, 0)

	spawnMobile("rori", "stormtrooper_bombardier_sentry", 360, -5585.6, 76.0, -5622.7, 163, 0)
	spawnMobile("rori", "stormtrooper_bombardier_sentry", 360, -5569.2, 76.0, -5617.7, 171, 0)
