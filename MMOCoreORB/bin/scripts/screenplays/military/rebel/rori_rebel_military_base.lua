...
function RoriRebelMilitaryBaseScreenPlay:spawnSceneObjects()	
	...
	-- Terminals
	spawnSceneObject("rori", "object/tangible/beta/beta_terminal_wound.iff", -5360.8, 76.0, 5046.0, 0, 1, 0, 0, 0)
	spawnSceneObject("rori", "object/tangible/terminal/terminal_mission_rebel.iff", -5364.0, 76.0, 5047.0, 0, 1, 0, 0, 0)
	spawnSceneObject("rori", "object/tangible/terminal/reb_travel_term.iff", -5311, 76, 5004, 0, 0, 0, 1, 0)
...
function RoriRebelMilitaryBaseScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "specforce_sentry", 300, -5328.4, 76.0, 5007.0, -175, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5335.3, 76.0, 4998.3, 155, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5318.8, 76.0, 5016.2, 93, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5307.6, 76.0, 5020.3, 124, 0)
	spawnMobile("rori", "gcw_rebel_defense_droid", 300, -5325.9, 76.0, 4995.6, 168, 0)
	spawnMobile("rori", "gcw_rebel_defense_droid", 300, -5300.4, 75.9, 5011.6, 76, 0)

	-- Building Sentries
	
	spawnMobile("rori", "specforce_sentry", 300, -5307.3, 75.9, 4984.4, -174, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5314.9, 75.9, 4983.9, 169, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5363.6, 76.0, 5077.4, 140, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5366.8, 76.0, 5074.6, 139, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5377.7, 76.0, 5064.9, 139, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5380.9, 76.0, 5062.1, 138, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5365.7, 76.0, 5048.3, 25, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5351.6, 76.0, 5052.7, -108, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5359.0, 76.0, 5044.5, 26, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5340.3, 76.0, 5029.4, -40, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5338.0, 76.0, 5030.5, -40, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5326.5, 76.0, 5024.8, -65, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5331.3, 76.0, 5025.3, -56, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5385.3, 76.0, 5025.3, -124, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5386.9, 76.0, 5027.7, -124, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5329.6, 76.0, 5078.0, 42, 0)
	spawnMobile("rori", "specforce_sentry", 300, -5331.8, 76.0, 5079.9, 41, 0)

	-- Turret Interiors

	spawnMobile("rori", "specforce_sniper_sentry", 300, -5335.0, 80.0, 5065.0, 152, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5342.1, 80.0, 5068.7, -141, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5340.9, 80.0, 5070.5, -48, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5374.9, 80.0, 5031.8, 126, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5372.6, 80.0, 5033.8, 54, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5376.5, 80.0, 5039.5, 25, 0)
	spawnMobile("rori", "specforce_sniper_sentry", 300, -5378.5, 80.0, 5039.0, -36, 0)
