...
HouseMerch = ScreenPlay:new {
	...
	goods = {
		{optName="Mustafarian Bunker Schematic", cost=12000000, itemName="Mustafarian Bunker Schematic", items={"object/tangible/loot/loot_schematic/musty_house_loot_schem.iff"}},
		{optName="Commando Bunker Schematic", cost=8000000, itemName="Commando Bunker Schematic", items={"object/tangible/loot/loot_schematic/commando_house_loot_schem.iff"}},
		{optName="VIP Bunker Schematic", cost=8000000, itemName="VIP Bunker Schematic", items={"object/tangible/loot/loot_schematic/vipbunker_house_loot_schem.iff"}},
		{optName="Tree House Schematic", cost=8000000, itemName="Tree House Schematic", items={"object/tangible/loot/loot_schematic/tree_house_loot_schem.iff"}},
		{optName="Bespin Cloud House Schematic", cost=15000000, itemName="Bespin Cloud House Schematic", items={"object/tangible/loot/loot_schematic/bespin_house_loot_schem.iff"}},
	},
}
...
function HouseMerch:start() 
	...
	spawnMobile("tatooine", "housemerch", 1, -2759.8, 5.0, 2297, -140, 0 ) -- Mos Espa 
	--spawnMobile("tatooine", "housemerch", 1, -2895.9, 5.0, 2286.2, 122, 3065451 ) -- Mos Espa 
...
housemerch_convo_handler = Object:new {	tstring = "myconversation" }
