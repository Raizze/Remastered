...
function JantaCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("dantooine", "janta_shaman_stronghold",900,-24.7064,-79.6773,-144.148,22,529332)
	spawnMobile("dantooine", "janta_shaman_stronghold",900,-19.5044,-79.2105,-140.846,-96,529332)
 ...
 --Rem Specific
	...
	spawnMobile("dantooine", "janta_harvester_stronghold",900,5.5,-30.2,-30.1,82,52924)
