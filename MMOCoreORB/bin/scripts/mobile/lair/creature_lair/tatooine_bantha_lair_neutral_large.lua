...
tatooine_bantha_lair_neutral_large = Lair:new {
	mobiles = {{"bantha",1},{"dwarf_bantha",1}},
	spawnLimit = 15,
...
addLairTemplate("tatooine_bantha_lair_neutral_large", tatooine_bantha_lair_neutral_large)
