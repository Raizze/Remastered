endor_gurreck_lair_neutral_medium = Lair:new {
	mobiles = {{"gurreck",1},{"prowling_gurreck",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_gurreck_lair_neutral_medium", endor_gurreck_lair_neutral_medium)
