...
yavin4_enraged_tybis_lair_neutral_medium = Lair:new {
	mobiles = {{"enraged_tybis", 1}},
	spawnLimit = 15,
...
addLairTemplate("yavin4_enraged_tybis_lair_neutral_medium", yavin4_enraged_tybis_lair_neutral_medium)
