corellia_domestic_humbaba_lair_neutral_medium = Lair:new {
	mobiles = {{"domestic_humbaba",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_domestic_humbaba_lair_neutral_medium", corellia_domestic_humbaba_lair_neutral_medium)
