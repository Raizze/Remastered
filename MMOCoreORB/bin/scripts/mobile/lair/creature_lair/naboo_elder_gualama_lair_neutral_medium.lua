naboo_elder_gualama_lair_neutral_medium = Lair:new {
	mobiles = {{"elder_gualama",1},{"dappled_gualama",1}},
	spawnLimit = 15,
...
addLairTemplate("naboo_elder_gualama_lair_neutral_medium", naboo_elder_gualama_lair_neutral_medium)
