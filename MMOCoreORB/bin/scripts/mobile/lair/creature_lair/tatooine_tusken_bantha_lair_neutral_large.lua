...
tatooine_tusken_bantha_lair_neutral_large = Lair:new {
	mobiles = {{"tusken_bantha",1}},
	spawnLimit = 15,
...
addLairTemplate("tatooine_tusken_bantha_lair_neutral_large", tatooine_tusken_bantha_lair_neutral_large)
