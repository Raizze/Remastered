...
// Remastered
#include "server/zone/custom/objects/tangible/components/CustomWearableObjectMenuComponent.h"
...
ComponentManager::ComponentManager() {
	...
	components.put("CustomWearableObjectMenuComponent", new CustomWearableObjectMenuComponent());
